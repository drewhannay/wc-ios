...
//  Wheaton App
//
//  Created by Chris Anderson on 1/14/14.
//
//
...
NSString * const c_Whoswho = @"http://dev.isoncamp.us/wheaton/person";
NSString * const c_Sports = @"http://dev.isoncamp.us/wheaton/sports";
...
NSString * const c_Favorites = @"http://192.168.1.127:3000/wheaton/person/favorites";
